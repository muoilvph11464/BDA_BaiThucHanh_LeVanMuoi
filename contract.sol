...
contract DinhGiaTaiSan is AccessControl{
   ...
   //map uint voi Thong tin nguoi yeu cau
    ...
    function PheDuyetYeuCauThanhNhaThamDinh (uint _MaYeuCau, uint8 intTrangThaiYeuCau) public {
        //Kiem tra Thong tin khong duoc rong
        ...
        //kiem tra co phai la admin khong
         ...
         objNguoiYeuCau.TrangThai = enTrangThaiYeuCauNTD(intTrangThaiYeuCau);
    ...
    function ThemMoiNhaThamDinh (address _DiaChiVi, string memory _HoVaTen , uint _Tuoi, uint _SoDienThoai, string memory _Email) public {
        ...
        //them address NTD vao mang nha tham dinh
    ...
    function ThamDinhTaiSan(uint _MaTaiSan ,string memory _ThongTinBoXung ,uint _GiaDuocDinh) public returns(uint maTaiSan) {
        
        //check trang thai
        TaiSan memory objTaiSan = DanhSachTaiSanYeuCauTao[_MaTaiSan];
        ...
        require(hasRole(NHATHAMDINH_ROLE, msg.sender), "Ban khon co quyen tham dinh");
        //check quyen tham dinh
        ...
        objTaiSan.MaHashThongTinTaiSan = _MaHashThongTinTaiSan; 
         ...
         return objTaiSan.MaTaiSan;
        
    }
    
    function HuyBoThamDinh(uint _MaTaiSan ,string memory _LyDoHuyBo ) public returns(uint maTaiSan) {
